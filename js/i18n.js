...
const translations = {
  'zh-HK': {
    ...
    home: {
      ...
      heroProof1: 'CMHK 相關產品核心基礎',
      heroProof2: '合規經營',
      heroProof3: '香港本地與電商多渠道',
      heroBtn: '查看產品資源',
  ...
  'zh-CN': {
    ...
    home: {
      ...
      heroProof1: 'CMHK 相关产品核心基础',
      heroProof2: '合规经营',
      heroProof3: '香港本地与电商多渠道',
      heroBtn: '查看产品资源',
  ...
  'en': {
    ...
    home: {
      ...
      heroProof1: 'CMHK-related product foundation',
      heroProof2: 'Compliant operations',
      heroProof3: 'Hong Kong local and ecommerce channels',
